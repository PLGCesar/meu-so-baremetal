...
static const uint8_t font8x8_basic[256][8] = {
    [(unsigned char)'á'] = {0x0C, 0x18, 0x00, 0x3C, 0x02, 0x3E, 0x46, 0x3E},
    [(unsigned char)'é'] = {0x0C, 0x18, 0x00, 0x3C, 0x42, 0x7E, 0x40, 0x3C},
    [(unsigned char)'í'] = {0x0C, 0x18, 0x00, 0x18, 0x18, 0x18, 0x18, 0x18},
    [(unsigned char)'ó'] = {0x0C, 0x18, 0x00, 0x3C, 0x42, 0x42, 0x42, 0x3C},
    [(unsigned char)'ú'] = {0x0C, 0x18, 0x00, 0x42, 0x42, 0x42, 0x42, 0x3E},
    [(unsigned char)'ã'] = {0x34, 0x2C, 0x00, 0x3C, 0x02, 0x3E, 0x46, 0x3E},
    [(unsigned char)'õ'] = {0x34, 0x2C, 0x00, 0x3C, 0x42, 0x42, 0x42, 0x3C},
    [(unsigned char)'â'] = {0x18, 0x24, 0x00, 0x3C, 0x02, 0x3E, 0x46, 0x3E},
    [(unsigned char)'ê'] = {0x18, 0x24, 0x00, 0x3C, 0x42, 0x7E, 0x40, 0x3C},
    [(unsigned char)'ô'] = {0x18, 0x24, 0x00, 0x3C, 0x42, 0x42, 0x42, 0x3C},
    [(unsigned char)'à'] = {0x18, 0x0C, 0x00, 0x3C, 0x02, 0x3E, 0x46, 0x3E},
    [(unsigned char)'ç'] = {0x00, 0x00, 0x3C, 0x60, 0x60, 0x3C, 0x18, 0x30},
    [(unsigned char)'Á'] = {0x0C, 0x18, 0x3C, 0x66, 0x7E, 0x66, 0x66, 0x00},
    [(unsigned char)'É'] = {0x0C, 0x18, 0x7E, 0x60, 0x78, 0x60, 0x7E, 0x00},
    [(unsigned char)'Í'] = {0x0C, 0x18, 0x3C, 0x18, 0x18, 0x18, 0x3C, 0x00},
    [(unsigned char)'Ó'] = {0x0C, 0x18, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00},
    [(unsigned char)'Ú'] = {0x0C, 0x18, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00},
    [(unsigned char)'Ã'] = {0x34, 0x2C, 0x3C, 0x66, 0x7E, 0x66, 0x66, 0x00},
    [(unsigned char)'Õ'] = {0x34, 0x2C, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00},
    [(unsigned char)'Â'] = {0x18, 0x24, 0x3C, 0x66, 0x7E, 0x66, 0x66, 0x00},
    [(unsigned char)'Ê'] = {0x18, 0x24, 0x7E, 0x60, 0x78, 0x60, 0x7E, 0x00},
    [(unsigned char)'Ô'] = {0x18, 0x24, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00},
    [(unsigned char)'À'] = {0x18, 0x0C, 0x3C, 0x66, 0x7E, 0x66, 0x66, 0x00},
    [(unsigned char)'Ç'] = {0x3C, 0x66, 0x60, 0x60, 0x3C, 0x18, 0x30, 0x00},
    ['!'] = {0x18, 0x18, 0x18, 0x18, 0x18, 0x00, 0x18, 0x00},
    ['@'] = {0x3C, 0x66, 0x6E, 0x6E, 0x60, 0x3E, 0x00, 0x00},
    ['$'] = {0x18, 0x3E, 0x60, 0x3C, 0x06, 0x7C, 0x18, 0x00},
    ['%'] = {0x63, 0x66, 0x0C, 0x18, 0x30, 0x66, 0x43, 0x00},
    ['^'] = {0x18, 0x36, 0x66, 0x00, 0x00, 0x00, 0x00, 0x00},
    ['&'] = {0x38, 0x6C, 0x38, 0x76, 0x6C, 0xCE, 0x73, 0x00},
