...
CMD dd if=/dev/zero of=disk.img bs=1k count=64 && \
    ...
    gcc -m32 -no-pie -fno-pic -T linker.ld -o myos.bin -ffreestanding -O2 -nostdlib boot.o gfx.o memory.o idt.o serial.o rtc.o vfs.o sound.o music.o bmp.o ui.o kernel.o -lgcc && \
